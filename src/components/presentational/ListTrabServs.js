    ...
    return (
      <ul className="ListTrabServs">
          ...
          <li id='dis_3d'>
              ...
              <a href="{ img_trab_url }ss/auto-v5.jpg" data-fancybox data-type="image" className="link-auto-v5 col_2 fon_3">Auto 5.0</a>
              <a href="{ img_trab_url }ss/bodyski.jpg" data-fancybox data-type="image" className="link-bodyski col_3 fon_1">BodySki</a>
          </li>
          <li id='dis_impr'>
          <span dangerouslySetInnerHTML={{__html: serv_impr }} />
              <a href="{ img_trab_url }ss/carteles.jpg" data-fancybox data-type="image" className="link-carteles col_2 fon_2">C.A. Colón</a>
              <a href="{ img_trab_url }ss/cyd-schaffer.jpg" data-fancybox data-type="image" className="link-cyd-schaffer col_3 fon_1">C&D Schaffer</a>
  { 
      // <a className="col_1 fon_2">La Higuera de Bartolo</a>
  }
              <a href="{ img_trab_url }ss/pronto-express.jpg" data-fancybox data-type="image" className="link-pronto-express col_1_2 fon_3">Pronto Express</a>
              <a href="{ img_trab_url }ss/canapina.jpg" data-fancybox data-type="image" className="link-canapina col_3 fon_2">Canapina</a>
              <a href="{ img_trab_url }ss/folletos.jpg" data-fancybox data-type="image" className="link-folletos col_5 fon_1">{ serv_folletos }</a>
          </li>
          <li id='dis_vid'>
              <span>{ serv_vid }:</span>
